...
const products = [
  {
    ...
    title: 'Pan de Yema',
    desc: 'Elaborado con yemas de huevo fresco, suave y esponjoso. Perfecto para el desayuno.',
    price: 'Q 0.00',
    tag: 'Clásico',
  },
  {
    img: 'https://images.pexels.com/photos/205961/pexels-photo-205961.jpeg?auto=compress&cs=tinysrgb&w=800',
    thumb: 'https://images.pexels.com/photos/205961/pexels-photo-205961.jpeg?auto=compress&cs=tinysrgb&w=400',
    title: 'Pan Artesanal de Trigo',
    desc: 'Masa madre con harina de trigo integral, horneado en horno de leña.',
    price: 'Q 0.00',
    tag: 'Artesanal',
  },
  {
    ...
    desc: 'Laminado con mantequilla europea, crujiente por fuera y suave por dentro.',
    price: 'Q 0.00',
    tag: 'Favorito',
  },
  {
    img: 'https://images.pexels.com/photos/1414234/pexels-photo-1414234.jpeg?auto=compress&cs=tinysrgb&w=800',
    thumb: 'https://images.pexels.com/photos/1414234/pexels-photo-1414234.jpeg?auto=compress&cs=tinysrgb&w=400',
    title: 'Pan de Chocolate',
    desc: 'Relleno de chocolate oscuro belga, ideal para merienda o postre.',
    price: 'Q 0.00',
    tag: 'Especial',
  },
  {
    img: 'https://images.pexels.com/photos/1099680/pexels-photo-1099680.jpeg?auto=compress&cs=tinysrgb&w=800',
    thumb: 'https://images.pexels.com/photos/1099680/pexels-photo-1099680.jpeg?auto=compress&cs=tinysrgb&w=400',
    title: 'Empanadas de Queso',
    desc: 'Masa hojaldrada rellena de queso fresco local. Receta familiar de generaciones.',
    price: 'Q 0.00',
    tag: 'Popular',
  },
  {
    img: 'https://images.pexels.com/photos/1346347/pexels-photo-1346347.jpeg?auto=compress&cs=tinysrgb&w=800',
    thumb: 'https://images.pexels.com/photos/1346347/pexels-photo-1346347.jpeg?auto=compress&cs=tinysrgb&w=400',
    title: 'Bolillo',
    desc: 'El pan de diario por excelencia. Crujiente, fresco y recién horneado cada hora.',
    price: 'Q 0.00',
    tag: 'Diario',
  },
];
    ...
    <>
      ...
      <div className="bg-xela-brown relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            src="https://images.pexels.com/photos/205961/pexels-photo-205961.jpeg?auto=compress&cs=tinysrgb&w=1200"
            alt=""
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 text-center">
          ...
          <p className="text-cream-200/70 mt-3 max-w-md mx-auto text-sm leading-relaxed">
            Panes artesanales elaborados diariamente con ingredientes seleccionados y
            técnicas tradicionales guatemaltecas.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl overflow-hidden shadow-sm border border-cream-200 hover:shadow-md transition-shadow duration-300 group"
            >
              <div
              ...
              >
                ...
                <div className="absolute top-3 left-3">
                  <span className="bg-xela-brown text-cream-100 text-[10px] font-semibold px-2.5 py-0.5 rounded-full">
                    {p.tag}
                  </span>
                </div>
              </div>
